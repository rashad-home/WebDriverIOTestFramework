...
const testFile = process.env.featureFileName;  // Feature file is named in environment file as 'featureFileName'


let featureFilePath = `${sourceSpecDirectory}/${testFile}.feature`;
...
if (argv.parallel === 'true') {
    ...
    featureFilePath = `${tmpSpecDirectory}//${testFile}.feature`;
}
